...
import { CustomerField, ExlinksForm } from '@/app/lib/definitions';
import {
    CheckIcon,
    ClockIcon,
    CurrencyDollarIcon,
...
import { updateExlink } from '@/app/lib/actions';
...
export default function EditInvoiceForm({
    ...
    const updateExlinkWithId = updateExlink.bind(null, link.id);
    const [stateLink, dispatch] = useFormState(updateExlinkWithId, initialState);
