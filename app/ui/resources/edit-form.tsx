...
import { CustomerField, ResourcesForm } from '@/app/lib/resources/definitions';
import {
    CheckIcon,
    ClockIcon,
    CurrencyDollarIcon,
...
import { updateResource } from '@/app/lib/resources/actions';
...
export default function EditInvoiceForm({
    ...
    const updateResourceWithId = updateResource.bind(null, link.id);
